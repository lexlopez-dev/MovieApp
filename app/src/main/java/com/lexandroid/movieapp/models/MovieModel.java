...
public class MovieModel implements Parcelable {
    ...
    * */
    ...
    //Constructor
    public MovieModel(int movie_id, String original_title, String poster_path, String release_date, String backdrop_path, int[] genre_ids, String overview, float vote_average, int vote_count) {
